...
// node_modules/v3-dragger/dist/index.js
var require_dist = __commonJS({
  "node_modules/v3-dragger/dist/index.js"(exports) {
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    var isTouchEvent = (e) => !!e.touches;
    exports.isTouchEvent = isTouchEvent;
    var beforeEventHandler = (e) => {
      var _a;
    ...
    var dragStartGeneric = (e, dragYOffset, dragYStart, dragXOffset, dragXStart, clientY, clientX, customDragStart) => {
      if (customDragStart) {
    ...
    var dragMoveGeneric = (e, dragYOffset, dragYStart, dragXOffset, dragXStart, clientY, clientX, customDragMove) => {
    ...
    var dragEndGeneric = (e, dragYOffset, dragYStart, dragXOffset, dragXStart, clientY, clientX, customDragEnd) => {
      if (customDragEnd) {
        customDragEnd(e, dragYOffset, dragYStart, dragXOffset, dragXStart, clientY, clientX);
      }
    };
    var vDraggerBeforeMount = (el, binding) => {
    ...
    var useDragger = (customDragEndGeneric, customDragMoveGeneric, customDragStartGeneric) => {
      ...
      const dragStart = (e) => {
        ...
        (0, exports.isTouchEvent)(e) ? dragStartGeneric(e, dragYOffset, dragYStart, dragXOffset, dragXStart, e.touches[0].clientY, e.touches[0].clientX, customDragStartGeneric) : dragStartGeneric(e, dragYOffset, dragYStart, dragXOffset, dragXStart, e.clientY, e.clientX, customDragStartGeneric);
      };
      const dragMove = (e) => {
        beforeEventHandler(e);
        (0, exports.isTouchEvent)(e) ? dragMoveGeneric(e, dragYOffset, dragYStart, dragXOffset, dragXStart, e.touches[0].clientY, e.touches[0].clientX, customDragMoveGeneric) : dragMoveGeneric(e, dragYOffset, dragYStart, dragXOffset, dragXStart, e.clientY, e.clientX, customDragMoveGeneric);
      };
      const dragEnd = (e) => {
        (0, exports.isTouchEvent)(e) ? dragEndGeneric(e, dragYOffset, dragYStart, dragXOffset, dragXStart, e.touches[0].clientY, e.touches[0].clientX, customDragEndGeneric) : dragEndGeneric(e, dragYOffset, dragYStart, dragXOffset, dragXStart, e.clientY, e.clientX, customDragEndGeneric);
      };
      const resetState = () => {
        dragYStart.value = 0;
        dragYOffset.value = 0;
    ...
    var useMobileDragger = (customDragEndGeneric, customDragMoveGeneric, customDragStartGeneric) => {
    ...
    var useDesktopDragger = (customDragEndGeneric, customDragMoveGeneric, customDragStartGeneric) => {
      const dragYStart = (0, vue_1.ref)(0);
      const dragYOffset = (0, vue_1.ref)(0);
      const dragXStart = (0, vue_1.ref)(0);
      const dragXOffset = (0, vue_1.ref)(0);
...
//# sourceMappingURL=v3-dragger.js.map
