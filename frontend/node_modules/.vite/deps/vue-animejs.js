...
var anime_es_exports = {};
__export(anime_es_exports, {
  default: () => anime_es_default
});
...
var require_vue_animejs = __commonJS({
  "node_modules/vue-animejs/index.js"(exports, module) {
    var anime2 = (init_anime_es(), __toCommonJS(anime_es_exports));
    if (anime2.default) {
      anime2 = anime2.default;
    }
    function install(Vue) {
      Vue.directive("anime", {
        bind: function bind(targets, binding) {
          var opts = Object.assign({}, binding.value, { targets });
          anime2(opts);
        }
      });
      Vue.prototype.$anime = anime2;
    }
    module.exports = {
      install
    };
...
export default require_vue_animejs();
//# sourceMappingURL=vue-animejs.js.map
